     ...
     <thead>
      ...
      <tr>
        ...
        <form action="/Evaluer/{{$candidat->id}}">
          @csrf
          @method('POST')
                         <a href="#" aria-hidden="true" data-toggle="modal" data-target="#myModal5{{$jury->id}}"style="font-size: 13px;color: black"><th>{{$candidat->user->nom}}&nbsp;{{$candidat->user->prenom}}</th></a><th> <input type="radio" name="candidature_id" id="id_sexe" value="{{$candidat->id}}"></th>
     ...
     <thead>
      ...
      <tr>
        ...
        <form action="/Changer/{{$candidat->id}}">
          @csrf
          @method('POST')
                        <th> <a href="#" aria-hidden="true" data-toggle="modal" data-target="#myModal{{$candidat->id}}">{{$candidat->user->nom}}&nbsp;{{$candidat->user->prenom}}</a></th><th> <input type="radio" name="candidature_id" id="id_sexe" value="{{$candidat->id}}"></th>
                              <div id="myModal{{$candidat->id}}" class="modal" tabindex="-1" role="dialog"  aria-labelledby="myModal1">
  <div class="modal-dialog modal-lg" role="document">
