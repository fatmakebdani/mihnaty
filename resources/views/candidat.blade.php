                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            ...
                            <div class="statistic-chart-1"style="background-color:#A6A4BB">
                                ...
                                <input  name="date" type="date" value="jj/mm/aaaa" id="example-date-input"  min="1960-01-01" max="2002-12-31"><br>
                            </div>
                        <!-- END CHART-->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="statistic-chart-1"style="background-color:#A6A4BB;">
                                ...
                                {{Form::submit('Submit', ['class'=>'genric-btn primary-border circle'])}}
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
