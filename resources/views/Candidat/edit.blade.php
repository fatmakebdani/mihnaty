    ...
    <div id="content" class="scroll">
        ...
        <section class="statistic-chart">
            <div class="container">
                ...
                {!! Form::open(['action' => ['CandidatController@update', $candidat->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            ...
                            <div class="statistic-chart-1"style="background-color:#A6A4BB">
                                ...
                                <label>Nom</label>
                                <input name='nom' type="text" class="form-control" id="id_nom" value="{{$candidat->nom}}">

                                <label>Prénom</label>
                                <input name="prenom" type="text" class="form-control" id="id_prenom" value="{{$candidat->prenom}}"><br>
                                @if ($candidat->sexe == "H")
                                ...
                                <label >Email</label>
                                <input name="email" type="email" class="form-control" id="id_email" value="{{$candidat->email}}"><br>

                                <label>N° de téléphone</label>
                                <input name="tel" type="tel" id="id_phone" value="{{$candidat->tel}}"><br>

                                <label>Date de naissance</label>
                                <input  name="date" type="date" id="example-date-input" value="{{$candidat->dateN}}"><br>
                            </div>
                        <!-- END CHART-->
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @foreach ($candidat->user->experiences as $experience)
                            <div class="statistic-chart-1"style="background-color:#A6A4BB " >
                                <p>Experience N° {{++$i}}</p>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="statistic-chart-1"style="background-color:#A6A4BB;">
                                <label>Titre</label>
                                <input name="titre" type="text" class="form-control" id="id_TitreE" value="{{$candidat->user->poste_courant->titre}}"><br>

                                <label>Nom entreprise</label>
                                <input name="nom_en_c" type="text" class="form-control" id="id_NomE" value="{{$candidat->user->poste_courant->entreprise}}"><br>

                                <label>Date de début</label>
                                <input name="date_debut_c" type="date" id="id_DateD" value="{{$candidat->user->poste_courant->debut}}"><br>

                                <label>Date jusqu'à présent</label>
                                <input name="date_fin_c" type="date" id="id_DateF" value="{{$candidat->user->poste_courant->fin}}"><br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @foreach ($candidat->user->diplomes as $diplome)
                            <!-- CHART-->
                            <div class="statistic-chart-1"style="background-color:#A6A4BB ">
                                <h6>Diplôme N° {{++$i}}</h6>
                                <label>Titre</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <!-- CHART-->
                            @foreach ($candidat->user->competences as $competence)
                            <div class="statistic-chart-1"style="background-color:#A6A4BB ">
